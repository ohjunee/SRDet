...
from models.model import Model, SR_Model
...
from utils.loss import ComputeLoss, SR_Loss
from utils.plots import plot_images, plot_labels, plot_results
from utils.torch_utils import ModelEMA, select_device, intersect_dicts, torch_distributed_zero_first, is_parallel
from utils.wandb_logging.wandb_utils import WandbLogger, check_wandb_resume
from utils.SR_utility import quantize, calc_psnr

logger = logging.getLogger(__name__) # 로거 이름이 패키지/모듈 계층을 추적한다는 것을 의미
...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained and not opt.using_pretrain_SR:
        # Optimizer
        ...
        del ckpt, state_dict
    if opt.using_pretrain_SR:
        del ckpt, state_dict

    if not opt.train_SRdata:
        # Image sizes
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/EDSR_x2/weights/best.pt', help='initial weights path')
    ...
    parser.add_argument('--name', default='EDSR_x4', help='save to project/name')
    ...
    # SR_model training
    parser.add_argument('--using_pretrain_SR', type=bool, default=False, help='use pretrained SR_model')
    parser.add_argument('--train_SRdata', type=bool, default=True, help='train super resolution model')
    parser.add_argument('--dir_data', type=str, default='E:/python/SRDet', help='dataset directory')
